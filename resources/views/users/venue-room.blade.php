                          ...
                          <div class="container">
                            ...
                            <div class="w3-container">
                                  <div class="evt-tab-inner text-center nav-tabs">
                                    <button class="w3-bar-item btn btn-light btn-lg tablink w3-red" onclick="openCity(event,'day1')"><h3><span>Day 1</span> &nbsp;&nbsp;&nbsp;&nbsp;Wed 26 Jun 2024</h3></button>
                                    <button class="w3-bar-item btn btn-light btn-lg tablink" onclick="openCity(event,'day2')"><h3>Day 2</span> &nbsp;&nbsp;&nbsp;&nbsp;Thur 27 Jun 2024</h3></button>
                                  </div>
                                    ...
                                    <div id="ex1-content">
                                      <div id="day1" class="w3-container w3-border city">
                                        <div class="row">
                                            @php
                                                $day1agenda = App\Models\Agenda::where('session_date', '2024-06-26')->where('venue_room_id', $room->id)->get();
                                            @endphp
                                      ...
                                      <div id="day2" class="w3-container w3-border city" style="display:none">
                                        <div class="row">
                                            @php
                                                $day2agenda = App\Models\Agenda::where('session_date', '2024-06-27')->where('venue_room_id', $room->id)->get();
                                            @endphp
