                    ...
                    <form action="{{ route('events.update', $event) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 col-lg-6 col-sm-12 {{ $errors->has('venue') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="venue" class="form-control" value="{{ old('venue', $event->venue->name) }}">
                            ...
                            <div class="form-group col-md-6 col-lg-6 col-sm-12 {{ $errors->has('location') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="location" class="form-control" value="{{ old('location', $event->venue->location->name) }}">
                                <input type="hidden" name="location_id" value="{{ $event->venue->location_id }}">
