...
<section class="bg-light">
    <div class="container p-5">
        <h1 class="display-5">Programme</h1>
          ...
          <div class="evt-tab-inner text-center nav-tabs">
            ...
            <div id="ex1-content">
              <div id="day1" class="w3-container w3-border city">
                <div class="row">
                    @php
                        $day1agenda = App\Models\Agenda::where('session_date', '2024-06-26')->get();
                    @endphp
              ...
              <div id="day2" class="w3-container w3-border city" style="display:none">
                <div class="row">
                    @php
                        $day2agenda = App\Models\Agenda::where('session_date', '2024-06-27')->get();
                    @endphp
