                              ...
                              @forelse ($users as $key => $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        {{ $order['trans_code'] ?? null}} 
                                    </td>
                                    <td> {{ $order['comments'] ?? null}}</td>
                                    <td>
                                        @php
                                            if($order != null){
                                                $orderitems = App\Models\OrderItem::with('ticket')->where('order_id', $order['id'])->orderBy('id', 'desc')->first() ?? null;
                                                $ticketdetails = App\Models\OrderTicketDetail::where('order_item_id', $orderitems['id'])->orderBy('id', 'desc')->first() ?? null;
                                            }
                                            else{
                                                $orderitems = null;
                                                $ticketdetails = null;
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="company" value="{{ old('company', $ticketdetails['company'] ?? null) }}" class="form-control">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label for="job_title">Job Title</label>
                                                                                <input type="text" name="job_title" value="{{ old('job_title', $ticketdetails['job_title'] ?? null) }}" class="form-control">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label for="address">Address</label>
                                                                                <textarea name="address" class="form-control">{{ old('address', $ticketdetails['address'] ?? null) }}</textarea>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label for="description">Description</label>
                                                                                <textarea name="description" class="form-control">{{ old('description', $ticketdetails['description'] ?? null) }}</textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="trans_code" value="{{ old('name', $order['trans_code'] ?? null) }}" class="form-control">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
